...
const CSS = `.falw{
  ...
  font-size:16px;line-height:1.65;-webkit-font-smoothing:antialiased}.falw img{max-width:100%;height:auto;display:block}.falw a{color:var(--maroon);text-decoration:none}.falw a:hover{text-decoration:underline}.falw .wrap{max-width:1080px;margin:0 auto;padding:0 28px}.falw .eyebrow{font-size:11px;letter-spacing:.22em;text-transform:uppercase;color:var(--maroon);
  font-weight:600;margin:0 0 10px}.falw .crule{width:56px;height:3px;background:var(--maroon);margin:0 0 26px}.falw /* header */
.topband{height:5px;background:var(--maroon)}.falw header.site{border-bottom:1px solid var(--rule);padding:22px 0}.falw header.site .inner{display:flex;align-items:center;justify-content:space-between;gap:24px;flex-wrap:wrap}.falw header.site .lock img{height:30px;width:auto;object-fit:contain}.falw header.site .lock .by{font-size:10.5px;letter-spacing:.3em;text-transform:uppercase;
...
.hero{padding:64px 0 44px;border-bottom:1px solid var(--rule)}.falw .hero .back{font-size:11px;letter-spacing:.18em;text-transform:uppercase;color:var(--muted);
...
.note{border:1px solid var(--rule);background:var(--paper);padding:24px 26px;margin-top:30px}.falw .note h4{font-size:11px;letter-spacing:.18em;text-transform:uppercase;color:var(--maroon);
...
footer.site{background:var(--ink);color:#B3B3B3;padding:44px 0 0;font-size:13px}.falw footer.site .cols{display:grid;grid-template-columns:1.4fr 1fr 1fr 1fr;gap:34px;padding-bottom:38px}.falw footer.site h5{font-size:11px;letter-spacing:.18em;text-transform:uppercase;color:#fff;
