...
export function CreatorMark() {
  ...
  return (
    <Link
      ...
      /*
       * Bottom-right corner. It was moved to the middle of the right edge on
       * 13 Sept 2026 and moved straight back the same day: Fenwick did not
       * like it there. Mid-right is more visible but it floats over the
       * middle of whatever you are reading, which the corner never does.
       * Do not move it again without being asked.
       *
