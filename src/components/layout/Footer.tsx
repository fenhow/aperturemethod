  ...
  return (
    <footer className="bg-dark text-white">
      <Container>
          ...
          <div className="sm:col-span-2 lg:col-span-1 lg:border-r lg:border-white/10 lg:pr-8">
            ...
            <div className="mt-6 text-small leading-relaxed text-white/55">
              ...
              <a
                ...
                className="mt-3 inline-flex h-11 w-11 items-center justify-center rounded-sm border border-white/15 sm:h-8 sm:w-8 text-white/70 transition-colors duration-fast hover:border-white/40 hover:text-white"
              >
        ...
        {/* Build stamp, its own hairline row, centered, deliberately the quietest thing on
