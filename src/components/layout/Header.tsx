            ...
            <div className="flex h-9 items-center justify-between gap-6 text-[12px] tracking-[0.01em] text-white/80">
              ...
              <div className="flex items-center gap-5 whitespace-nowrap">
                ...
                <a
                  ...
                  aria-label="LinkedIn"
                  /*
                   * The icon is 15px; the link was too. Padding takes the
                   * touch target to 40px and the negative margin keeps the
                   * icon exactly where it was in the strip.
                   */
                  className="-m-3 inline-flex items-center justify-center p-3 transition-colors hover:text-white"
                >
            ...
            <nav aria-label="Primary" className="hidden items-center gap-6 lg:flex xl:gap-8">
              ...
              <Link
                ...
                className={cn(
                  ...
                  // Hovers to black in both header states, so the button
                  // behaves the same whether or not the bar has collapsed.
                  "hover:bg-ink hover:text-paper",
                  scrolled ? "bg-paper text-maroon" : "bg-maroon text-paper"
                )}
              >
                {primaryCta.label}
              </Link>
          ...
          >
            <Container>
              <div className="grid grid-cols-[0.9fr_1.5fr] gap-10 py-8">
                {/*
                  Hub descriptor box. `self-start` matters: as a grid child it
