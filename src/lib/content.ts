...
export const methodPhases: MethodPhase[] = [
  ...
  },
  {
    ...
    frameworks: [
      { name: "Common-size analysis", what: "Restates every line as a share of revenue or of total assets, so the shape of the business shows up rather than its size, and any year is comparable to any other." },
      ...
      { name: "The notes", what: "Receivables quality, inventory basis, deferred revenue and the age of the asset base. Where the face of the statements stops and the disclosure starts." },
      { name: "Break-even & margin of safety", what: "How far revenue can fall before operating income turns negative, stated as a percentage rather than a feeling." },
      { name: "Lever sizing", what: "What one point of gross margin, one percent of revenue or one day of inventory is actually worth, ranked, so effort goes where the arithmetic says it pays." },
      { name: "Price against volume", what: "A grid showing how much volume a price rise can afford to lose before it destroys value. A pricing case argued on margin alone has not answered that question." },
      { name: "Scenario planning", what: "A multi-year driver-based model, yours to keep, so a price change, a hire or an expansion can be tested before you commit to it." },
    ],
  },
  {
    n: "03",
